...
**Submit:** `marp/1_apis.md` — **Pages:** *12* 
...
**Answer:** I implemented **10** REST APIs.
...
**Submit:** `marp/3_mysql.md` — **Pages:** *10*
...
- Slides: `marp/4_example.md` — **Pages:** *15*  
...
**Submit:** `marp/5_security.md` — **Pages:** *15 *
...
- Presentation file in `presentation/` named `Bebba_student_course_system.md`  
- **Total pages:** (*44*)  
- **[T]** Covered **all 5 topics**: (1) PHP, (2) MySQL, (3) REST APIs, (4) Security, (5) Access via curl/HTML/JS
